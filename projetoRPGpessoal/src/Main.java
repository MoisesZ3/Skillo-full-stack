...
public class Main {
    public static void main(String[] args) {
        ...
        //O while acima esta correto, ele esta verificando se as duas condições são verdadeiras para o loop continuar
        //rodando e no momento em que o personagem ou o inimigo fica com zero de vida umas das condições fica false
        //e encerra o loop.
